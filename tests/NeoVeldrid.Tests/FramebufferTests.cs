...
public abstract class FramebufferTests<T> : GraphicsDeviceTestBase<T> where T : GraphicsDeviceCreator
{
    ...
    public void NoColorTarget_ClearColor_Fails()
    {
        ...
        cl.Begin();
        cl.SetFramebuffer(fb);
        Assert.Throws<NeoVeldridException>(() => cl.ClearColorTarget(0, RgbaFloat.Red));
    }
    ...
    public void ClearColorTarget_OutOfRange_Fails()
    {
        ...
        Assert.Throws<NeoVeldridException>(() => cl.ClearColorTarget(2, RgbaFloat.Red));
        Assert.Throws<NeoVeldridException>(() => cl.ClearColorTarget(3, RgbaFloat.Red));
    }
